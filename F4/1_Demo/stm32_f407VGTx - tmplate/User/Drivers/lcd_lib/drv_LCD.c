...
/**
  * @brief  格式转换
	* @param	c: GBR格式的颜色值
	* @note   从ILI93xx读出的数据为GBR格式，而我们写入的时候为RGB格式。
	* @return RGB格式的颜色值
 **/
...
{  							  
	...
	for(t=0;t<csize;t++)
	{   
		if(size==12)temp=asc2_1295[num][t]; 	 	//调用1295字体
		else if(size==16)temp=asc2_1695[num][t];	//调用1695字体
		else if(size==24)temp=asc2_3695[num][t];	//调用3695字体
		else if(size==32)temp=asc2_12895[num][t];	//调用12895字体
		else return;								//没有的字库
		for(t1=0;t1<8;t1++)
		{			    
